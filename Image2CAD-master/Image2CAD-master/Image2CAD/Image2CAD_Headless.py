...
(Modified for Headless execution)
"""
...
def main(argv1):
    ...
    # Add script directory to sys.path to allow imports after chdir
    ...
    print("Image2CAD Headless Script Started at " + Start_time + "...")
    ...
    print("Correlation of Dimensions Started...")
    ...
    print("Image2CAD Headless Script Execution Complete...")
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        print("Usage: python Image2CAD_Headless.py <image_path>")
